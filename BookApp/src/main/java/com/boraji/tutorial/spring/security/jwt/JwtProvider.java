package com.boraji.tutorial.spring.security.jwt;
...
import com.boraji.tutorial.spring.security.jwt.exception.InvalidTokenException;
import com.boraji.tutorial.spring.security.service.UserPrincipal;

@Component
@PropertySource(value = "claspath:security.properties")
public class JwtProvider {
	private Logger LOGGER = Logger.getLogger(JwtProvider.class);
	@Value("{$jwtSecret}")
